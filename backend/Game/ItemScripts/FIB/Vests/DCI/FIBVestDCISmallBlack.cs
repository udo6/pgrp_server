...
namespace Game.ItemScripts.FIB.Vests.DCI
{
    public class FIBVestDCISmallBlack : ItemScript
    {
        private static readonly int ArmorDrawable = 1;
        private static readonly int ArmorTexture = 16;
        private static readonly uint ArmorDlc = 3602239810;

        public FIBVestDCISmallBlack() : base(169, true)
        {
        }
