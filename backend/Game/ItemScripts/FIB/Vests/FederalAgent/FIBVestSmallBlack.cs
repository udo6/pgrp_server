...
namespace Game.ItemScripts.FIB.Vests.FederalAgent
{
    public class FIBVestSmallBlack : ItemScript
    {
        private static readonly int ArmorDrawable = 1;
        private static readonly int ArmorTexture = 10;
        private static readonly uint ArmorDlc = 3602239810;

        public FIBVestSmallBlack() : base(281, true)
        {
        }
