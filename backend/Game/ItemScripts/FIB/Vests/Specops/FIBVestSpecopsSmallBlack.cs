...
namespace Game.ItemScripts.FIB.Vests.Specops
{
    public class FIBVestSpecopsSmallBlack : ItemScript
    {
        private static readonly int ArmorDrawable = 1;
        private static readonly int ArmorTexture = 18;
        private static readonly uint ArmorDlc = 3602239810;

        public FIBVestSpecopsSmallBlack() : base(155, true)
        {
        }
