...
namespace Game.ItemScripts.FIB.Vests.Training
{
    public class FIBVestTrainingSmallBlack : ItemScript
    {
        private static readonly int ArmorDrawable = 1;
        private static readonly int ArmorTexture = 12;
        private static readonly uint ArmorDlc = 3602239810;

        public FIBVestTrainingSmallBlack() : base(151, true)
        {
        }
