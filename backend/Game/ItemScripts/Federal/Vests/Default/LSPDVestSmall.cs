...
namespace Game.ItemScripts.Federal.Vests.Default
{
	public class LSPDVestSmall : ItemScript
	{
		private static readonly int MaleArmorDrawable = 1;
		private static readonly int MaleArmorTexture = 0;
		private static readonly uint MaleArmorDlc = 3602239810;


		private static readonly int FemaleArmorDrawable = 1;
		private static readonly int FemaleArmorTexture = 0;
		private static readonly uint FemaleArmorDlc = 889305561;

		public LSPDVestSmall() : base(309, true)
		{
		}
